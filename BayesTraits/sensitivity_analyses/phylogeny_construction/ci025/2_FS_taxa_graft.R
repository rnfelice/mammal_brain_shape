...
#first load in the FS tree
mamTree_FS <-read.tree("./phylogeny_construction/Complete_phylogeny_Faurby_Svenning.txt")
...
merged_tree_B <- tree.merger(backbone=full_mamTree,data=pairs_B2,
                           tip.ages=tip.ages_B, 
                           plot=F)
